...
//  ArtNYC
//
//  Created by Jacqueline Minneman on 9/7/17.
...
class MuseumHardCoded {
    ...
    let allMuseums = [metMuseum, rubinMuseum, frick, moma, guggenheim, neueGalerie, whitney, jewishMuseum, folkArt, newMuseum, museoDelBarrio, mad, cooperHewitt, drawingCenter, cloisters, metBreuer, fit, morganLibrary, asiaSociety, brooklyn, momaPS1, noguchi, queens, hispanicSociety]
    
//    allMuseums = allMuseums.sorted { (museum1, museum2) -> Bool in
